...
let i = 0;
let proj1Stop = setInterval(proj1Set, 4000);
function proj1Set() {
...
proj1Next.addEventListener("click", function () {
  ...
  Pro1render();
  proj1Stop = setInterval(proj1Set, 4000);
});
...
proj1Img.addEventListener("mouseenter", () => {
  clearInterval(proj1Stop);
});
proj1Img.addEventListener("mouseleave", () => {
  proj1Stop = setInterval(proj1Set, 4000);
});
